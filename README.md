...
### Credits
Twitter data have been collected by [IFISC](https://ifisc.uib-csic.es/en/) for research purposes. Thanks to [LARUS](@larusba) for the support in the graph database procedures and management.
